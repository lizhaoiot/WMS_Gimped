...
namespace WMS_Gimped.Log
{
    ...
    {
        //产品入库记录
        public void LOG(Model.Log model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into WMS_Log(");
            strSql.Append("ID,BDBH,ZDR,ZDRQ,IP,MAC,Type,CW,SL");
            ...
            SqlParameter[] parameters = {
                        ...
                        new SqlParameter("@BDBH", SqlDbType.VarChar,100) ,
                        ...
                        new SqlParameter("@CW", SqlDbType.VarChar,50) ,
                        new SqlParameter("@SL", SqlDbType.BigInt,8)

            };

            parameters[0].Value = model.Id;
            parameters[1].Value = model.Bdbh;
            parameters[2].Value = model.Zdr;
            parameters[3].Value = model.Zdrq;
            parameters[4].Value = model.Ip;
            parameters[5].Value = model.Mac;
            parameters[6].Value = model.Type;
            parameters[7].Value = model.Cw;
            parameters[8].Value = model.Sl;
            SqlHelper.ExecCommand(strSql.ToString(), parameters);
        }
    }
    /// <summary>
    /// 写日志的参数获取方法
