...
{
    public partial class DisplayCPKC : Form
    {
        #region 定量
        public string CPBH = null;
        private static DisplayCPKC frm = null;
        #endregion
        ...
        public static DisplayCPKC CreateInstrance()
        {
        ...
        private void DisplayCPKC_Load(object sender, EventArgs e)
        {
            this.WindowState = FormWindowState.Maximized;
            toolStripTextBox1.Text = CPBH;
            SqlParameter[] para = { new SqlParameter("@DAH", SqlDbType.Text) };
            para[0].Value = toolStripTextBox1.Text;
            DataTable dt1 = SqlHelper.ExecStoredProcedureDataTable("WMS_ProductQuery3", para);
        ...
        {
            Export2Excel("产品实际库存", GetDgvToTable(dataGridView1));
        }
        #endregion
