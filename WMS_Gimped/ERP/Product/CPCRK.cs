...
{
    public partial class CPCRK : UserControl
    {
        #region 定量
        private static CPCRK frm = null;
        #endregion
        ...
        #region 初始化
        public static CPCRK CreateInstrance()
        {
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt1 = SqlHelper.ExecStoredProcedureDataTable("HUI_QUERY_CPCRK", para);
        ...
        {
            Export2Excel("ERP产品出入库", GetDgvToTable(dataGridView1));
        }
        #endregion
