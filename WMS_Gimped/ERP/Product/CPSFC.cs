...
namespace WMS_Gimped.ERP.Product
{
    public partial class CPSFC : UserControl
    {
        #region 定量
        private static CPSFC frm = null;
        #endregion

        #region 变量
        DevExpress.XtraEditors.DateEdit de1 = new DevExpress.XtraEditors.DateEdit();
        DevExpress.XtraEditors.DateEdit de2 = new DevExpress.XtraEditors.DateEdit();
        #endregion

        #region 初始化
        public static CPSFC CreateInstrance()
        {
        ...
        public CPSFC()
        {
            ...
            de1.Width = 120;
            de1.Properties.VistaDisplayMode = DefaultBoolean.True;
            de1.Properties.VistaEditTime = DefaultBoolean.True;
            de1.Properties.DisplayFormat.FormatString = "yyyy-MM-dd HH:mm:ss";
            de1.Properties.DisplayFormat.FormatType = DevExpress.Utils.FormatType.DateTime;
            de1.Properties.EditFormat.FormatString = "yyyy-MM-dd HH:mm:ss";
            de1.Properties.EditFormat.FormatType = DevExpress.Utils.FormatType.DateTime;
            de1.Properties.Mask.EditMask = "yyyy-MM-dd HH:mm:ss";
            ToolStripControlHost th = new ToolStripControlHost(de1);
            toolStrip1.Items.Insert(1, th);


            de2.Width = 160;
            de2.Properties.VistaDisplayMode = DefaultBoolean.True;
            de2.Properties.VistaEditTime = DefaultBoolean.True;
            de2.Properties.DisplayFormat.FormatString = "yyyy-MM-dd HH:mm:ss";
            de2.Properties.DisplayFormat.FormatType = DevExpress.Utils.FormatType.DateTime;
            de2.Properties.EditFormat.FormatString = "yyyy-MM-dd HH:mm:ss";
            de2.Properties.EditFormat.FormatType = DevExpress.Utils.FormatType.DateTime;
            de2.Properties.Mask.EditMask = "yyyy-MM-dd HH:mm:ss";
            ToolStripControlHost th1 = new ToolStripControlHost(de2);
            toolStrip1.Items.Insert(3, th1);
        }
        #endregion
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            para[1].Value = Convert.ToDateTime(de1.Text);
            para[2].Value = Convert.ToDateTime(de2.Text);

            DataTable dt1 = SqlHelper.ExecStoredProcedureDataTable("HUI_QUERY_CPSFC", para);
        ...
        {
            Export2Excel("ERP产品收发存", GetDgvToTable(dataGridView1));
        }
        #endregion
