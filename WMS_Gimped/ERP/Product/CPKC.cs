...
{
    public partial class CPKC : UserControl
    {

        #region 定量
        private static CPKC frm = null;
        #endregion
        ...
        public static CPKC CreateInstrance()
        {
        ...
        private void CPKC_Load(object sender, EventArgs e)
        {
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt1 = SqlHelper.ExecStoredProcedureDataTable("HUI_QUERY_CPSJKC", para);
        ...
        {
            Export2Excel("ERP产品实际库存", GetDgvToTable(dataGridView1));
        }
        #endregion
