...
{
    public partial class WLCRK : UserControl
    {
        #region 定量
        private static WLCRK frm = null;
        #endregion
        ...
        public static WLCRK CreateInstrance()
        {
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt1 = SqlHelper.ExecStoredProcedureDataTable("HUI_QUERY_CLCRK", para);
        ...
        {
            Export2Excel("ERP材料出入库", GetDgvToTable(dataGridView1));
        }
        #endregion
