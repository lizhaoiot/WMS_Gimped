...
{
    public partial class WLSFC : UserControl
    {
        #region 变量
        private static WLSFC frm = null;
        #endregion
        ...
        public static WLSFC CreateInstrance()
        {
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt1 = SqlHelper.ExecStoredProcedureDataTable("HUI_QUERY_CLSFC", para);
        ...
        {
            Export2Excel("ERP材料收发存", GetDgvToTable(dataGridView1));
        }
        #endregion
